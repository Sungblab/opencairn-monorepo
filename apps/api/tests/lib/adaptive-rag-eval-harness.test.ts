  ...
  },
  {
    ...
    expectedReport: {
      ...
      packedEvidenceStats: {
        ...
        totalCandidates: 4,
        omittedCandidates: 1,
        itemEvidenceIds: ["research-a", "research-b", "research-d"],
        perNoteCounts: { "note-research": 2, "note-background": 1 },
      },
    },
  },
  {
    ...
    expectedReport: {
      ...
      packedEvidenceStats: {
        ...
        totalCandidates: 4,
        omittedCandidates: 1,
        itemEvidenceIds: ["relationship-a", "relationship-c", "relationship-d"],
  ...
  },
  {
    ...
    expectedReport: {
      ...
      packedEvidenceStats: {
        ...
        totalCandidates: 4,
        omittedCandidates: 1,
        itemEvidenceIds: ["multi-hop-a", "multi-hop-c", "multi-hop-d"],
  ...
  },
  {
    ...
    expectedReport: {
      ...
      packedEvidenceStats: {
        ...
        totalCandidates: 4,
        omittedCandidates: 0,
        itemEvidenceIds: ["fanout-a", "fanout-b", "fanout-c", "fanout-d"],
        perNoteCounts: {
          "note-project-a": 2,
          "note-project-b": 1,
          "note-project-c": 1,
