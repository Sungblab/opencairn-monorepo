...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  const [common, landing, dashboard, sidebar, app, editor, auth, collab, importMessages] = await Promise.all([
  ...
  return {
    locale,
    messages: { common, landing, dashboard, sidebar, app, editor, auth, collab, import: importMessages },
  };
});
