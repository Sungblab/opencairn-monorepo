...
const TONE = {
  light: {
    ...
    item: "hover:bg-stone-900 hover:text-stone-50 focus:bg-stone-900 focus:text-stone-50 data-[highlighted]:bg-stone-900 data-[highlighted]:text-stone-50",
    code: "text-stone-500",
    name: "text-stone-900",
    check: "text-stone-900",
  },
  dark: {
    trigger:
    ...
    item: "hover:bg-stone-50 hover:text-stone-900 focus:bg-stone-50 focus:text-stone-900 data-[highlighted]:bg-stone-50 data-[highlighted]:text-stone-900",
    code: "text-stone-500",
    name: "text-stone-50",
    check: "text-stone-100",
  },
} as const;
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        className={`inline-flex items-center gap-1.5 rounded-full border-2 bg-transparent px-3 py-1.5 font-sans text-[11px] font-semibold tracking-widest uppercase transition-colors ${palette.trigger}`}
      >
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={8}
        className={`min-w-[180px] rounded-xl p-1.5 ${palette.content}`}
      >
        {locales.map((loc) => {
