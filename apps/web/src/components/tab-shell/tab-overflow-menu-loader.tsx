...
function TabOverflowMenuTrigger({
  ...
  return (
    <button
      ...
      className={`flex h-10 w-9 shrink-0 items-center justify-center border-l border-border text-muted-foreground transition-colors ${
        disabled ? "opacity-70" : "hover:bg-muted hover:text-foreground"
      }`}
    >
