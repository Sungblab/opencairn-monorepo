  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        className="inline-flex min-h-7 items-center rounded-[var(--radius-control)] border border-border px-2.5 py-1 text-xs uppercase tracking-wide transition-colors hover:border-foreground"
      >
        {t(value)}
      </DropdownMenuTrigger>
