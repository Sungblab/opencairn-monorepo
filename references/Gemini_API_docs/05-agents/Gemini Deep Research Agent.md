...
2. **Last Event ID:** The ID of the last successfully processed event. This tells the server to resume sending events _after_ that specific point. If not provided, you will get the beginning of the stream.
