...
// module. Export the runtime tuple for UI/test consumers that need to
// enumerate the accepted languages without duplicating the literals.
export const canvasLanguages = canvasLanguageSchema.options;
