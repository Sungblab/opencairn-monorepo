...
| 3 | Tier 2 #2.2: `apps/api/Dockerfile` + `apps/web/Dockerfile` + profile-gated compose app path | **CLOSED / partially closed 2026-04-28**. API/Web image + compose path exists; CI/CD and multi-arch automation still open. |
