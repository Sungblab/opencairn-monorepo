...
| Plan                                                   | Status                            | Summary                                                                                                                                                                                                                                                                                                              |
| ------------------------------------------------------ | --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `2026-04-09-plan-2-editor.md`                          | 🟡 미착수                         | Plate v49 에디터 + Notion급 협업 (Hocuspocus, 코멘트, @mention, 알림, 공개 링크, guest 초대). Claude급 채팅 렌더러 + 에디터 블록(Mermaid/SVG/KaTeX/Toggle/Table/Column) + Chat→Editor 변환. Multi-Mode Tab Shell + Split Pane + Diff View + Command Palette. 상세 specs: `tab-system-design.md`.                       |
