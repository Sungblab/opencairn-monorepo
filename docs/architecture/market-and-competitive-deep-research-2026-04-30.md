...
> staged AI workflows, multi-LLM, Plate v49 editor + Hocuspocus 협업 + Cytoscape KG + Synthesis Export +
...
| Specialized AI workflows + cron orchestration | ✅ Synthesis/Curator/Connector/Staleness/Narrator 등 staged roles | ⚠️ custom agent 1종 | ⚠️ Agentic RAG | ⚠️ Agent Flows(visual) | ⚠️ Custom Agents (closed) | ❌ |
...
"Plate 블록 에디터 + Yjs 협업 + Cytoscape KG 5뷰 + staged AI workflows + SM-2 + Deep Research + Synthesis Export(LaTeX/Tectonic) **를 AGPLv3로 한 Docker compose에 묶고 한국어 1급 + Gemini/Ollama BYOK + 3계층 workspace 격리까지 보장**" — 비교 가능한 OSS 제품 0개.
