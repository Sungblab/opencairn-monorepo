...
Expose authenticated, project-scoped list/detail APIs that adapt existing chat
runs, agent actions, Plan8 summaries, and document-generation actions where the
data already exists.
