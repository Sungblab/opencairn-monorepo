...
- `COMMERCIAL-LICENSING.md` — 상용 라이선스 프로그램 설명 (라이선스 텍스트 자체는 아님; GitHub Discussion + 임시 이메일 → 향후 `licensing@opencairn.com`)
...
- `COMMERCIAL-LICENSING.md`와 CLA 텍스트는 baseline 템플릿. 중대 상업 결정 시 별도 법률 검토 필요
