...
AI-powered personal knowledge OS. 12 에이전트, multi-LLM (Gemini/Ollama), Docker self-hosted.
...
>
> 2026-04-15 업데이트: OpenAI provider 제거. `packages/llm`은 Gemini + Ollama 2개만 지원. 문서 전역 반영 완료.
...
| 보안 모델 (BYOK 키, RLS, CSP, rate limit) | `docs/architecture/security-model.md` |
