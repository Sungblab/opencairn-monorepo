...
- 🟡 Active / next: Plan 2C (notifications + share), 2D (chat renderer + block extensions), App Shell Phase 4~5 (agent panel, palette), Plan 5/6/8, Plan 7 Phase 2 (Code Agent + /api/code/run + Monaco), Deep Research prod release (manual env flip).
